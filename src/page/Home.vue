...
const allTopicProgression = computed(() => {
  const completeTopic = (topics.value || []).filter(
    (ct) => ct.status === "Complete"
  );
...
<template>
  <div class="2xl:container 2xl:mx-auto">
    ...
    <section class="my-section-home" v-if="!isLoading">
      ...
      >
        <h3
          class="font-bold text-slate-300 phone:text-base sm:text-lg lg:text-sm 2xl:text-xl"
        >
          OWW studio
        </h3>
        <h2
          class="capitalize text-lg text-blue-50 font-bold phone:text-2xl sm:text-3xl lg:text-xl 2xl:text-4xl"
        >
      ...
      <main
        class="w-full lg:max-h-[32rem] bg-white border-t-8 border-t-blue-600 border border-slate-400 phone:flex phone:flex-col sm:flex sm:flex-col xl:grid xl:grid-cols-myHomeTemplate mb-6 overflow-y-auto"
      >
        <!-- Left column -->
        <div class="border-r border-r-slate-400 p-4 col-start-1 col-end-1">
          ...
          <div class="flex flex-col justify-center items-center bg-slate-100">
            ...
            <ul
              class="phone:flex phone:flex-row justify-center gap-8 items-center mb-6"
            >
              <li>
              ...
              <li>
                <PhUser
                  class="phone:h-20 phone:w-20 sm:h-32 sm:w-32 lg:h-12 lg:w-12 2xl:h-16 2xl:w-16 border-2 border-slate-700 rounded-full object-cover shadow-md"
                >
                </PhUser>
                <!-- <img
                  :src="users[0].imgUrl"
      ...
      >
        ...
        >
          <PresentationChartLineIcon
            class="phone:h-10 phone:w-10 sm:h-12 sm:w-12 lg:h-8 lg:w-8 2xl:h-12 2xl:w-12 fill-blue-50 px-2 border-r border-r-slate-50"
          ></PresentationChartLineIcon>
      ...
      <div
        class="phone:flex phone:flex-col lg:grid lg:grid-cols-4 gap-8 py-8 bg-white border-t-8 border-t-blue-600 border border-slate-400"
      >
        <div
          class="phone:h-32 phone:w-32 sm:w-32 sm:h-32 lg:w-32 lg:h-32 2xl:w-44 2xl:h-44 relative mx-auto sm:-z-0"
        ...
        >
          <div class="relative w-full h-full">
            ...
            >
              <div
                class="progress-circle bg-transparent border-blue-200 phone:border-8 lg:border-8 2xl:border-[12px] rounded-full w-full h-full clip-auto"
              ></div>
              <div
...
.my-header-paragraph-home {
  @apply text-slate-900 font-semibold phone:text-lg sm:text-xl lg:text-base 2xl:text-xl;
}

.my-header-sub-paragraph-home {
  @apply text-slate-500 phone:text-sm sm:text-base lg:text-xs 2xl:text-base font-semibold;
}

.my-main-header-home {
  @apply text-slate-900 phone:text-base sm:text-lg lg:text-base 2xl:text-xl;
}

.my-main-paragraph-home {
  @apply phone:text-base sm:text-lg lg:text-sm 2xl:text-lg;
}

.my-main-sub-paragraph-home {
  @apply phone:text-sm sm:text-base lg:text-xs 2xl:text-base font-semibold phone:mb-6 lg:mb-2;
}
...
.before-progression {
  @apply absolute inset-0 bg-transparent border-blue-500 phone:border-8 lg:border-8 2xl:border-[12px] rounded-full w-full h-full;
}
